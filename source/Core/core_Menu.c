...
void Core_MenuInit(TCoreMenu *p)
{
		...
		p->MinMaxGain = &g_Ram.ramGroupC.MaxTorque;   // Коэффициент диапазона
		...
		p->EvLogCount = &g_Ram.ramGroupH.LogEvCount;	 // Количество сделанных записей в журнал
		...
		p->Express.List1.Buf[0] = GetAdr(ramGroupB.DevTime);		// Параметры экспресс настройки
		p->Express.List1.Buf[1] = GetAdr(ramGroupB.DevDate);		// Параметры экспресс настройки
		p->Express.List1.Buf[2] = GetAdr(ramGroupB.RodType);		// Параметры экспресс настройки
		p->Express.List1.Buf[3] = GetAdr(ramGroupB.ValveType);		// Параметры экспресс настройки
		p->Express.List1.Buf[4] = 0;		// Параметры экспресс настройки

		p->Express.List2.Cnt = 2;		// Параметры экспресс настройки
		p->Express.List2.Buf[0] = GetAdr(ramGroupB.MoveCloseTorque);		// Параметры экспресс настройки
		p->Express.List2.Buf[1] = GetAdr(ramGroupB.MoveOpenTorque);		// Параметры экспресс настройки
		...
		p->Express.List3.Buf[0] = GetAdr(ramGroupD.TaskClose);		// Параметры экспресс настройки
		...
		p->Express.List4.Buf[0] = GetAdr(ramGroupD.TaskOpen);		// Параметры экспресс настройки
		...
		p->Express.List5.Buf[0] = GetAdr(ramGroupD.RevOpen);		// Параметры экспресс настройки
		...
		p->Express.List6.Buf[0] = GetAdr(ramGroupD.RevClose);		// Параметры экспресс настройки
		...
		p->Express.List7.Buf[0] = GetAdr(ramGroupB.BreakCloseTorque);		// Параметры экспресс настройки
		...
		p->Express.List8.Buf[0] = GetAdr(ramGroupB.StartCloseTorque);		// Параметры экспресс настройки
		...
		p->Express.List9.Buf[0] = GetAdr(ramGroupB.BreakOpenTorque);		// Параметры экспресс настройки
		...
		p->Express.List10.Buf[0] = GetAdr(ramGroupB.StartOpenTorque);		// Параметры экспресс настройки
		...
		p->Express.List12.Buf[0] = GetAdr(ramGroupB.MuDuSetup);		// Параметры экспресс настройки
...
{
    Uns displPosition = 0;
    displPosition = !g_Ram.ramGroupA.Faults.Dev.bit.PosSens ? g_Ram.ramGroupA.PositionPr : 9999; // Если "сбой датчика положения", выводим 999.9
