...
typedef struct {
	...
	Uns 				kvokvzOffFlag;		// флаг размыкания КВО и КВЗ (при повороте ручки стоп, провал питания, отсутствие связи с БКП) - Требования ДИТ от 03.12.19
	Uns					ButtonsState; 		// Состояние кнопок
	Uns					bkpNotConnected;	// Флаг отсутствия связи с БКП (выставляется в 1 при инициализации БКЭП и снимается только когда связь с БКП налажена)
} TComm;
//--------------------------------------------------------
