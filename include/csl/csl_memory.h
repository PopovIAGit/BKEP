...
#define ReadPar(Adr, Buf, Cnt)  	ParFunc(&Eeprom1,     F_READ,  Adr, (Ptr)(Buf), Cnt)
#define WritePar(Adr, Buf, Cnt) 	ParFunc(&Eeprom1,     F_WRITE, Adr, (Ptr)(Buf), Cnt)

#define ReadLog(Adr, Buf, Cnt)  	LogFunc(&Eeprom2,     F_READ,  Adr, (Ptr)(Buf), Cnt)
#define WriteLog(Adr, Buf, Cnt) 	LogFunc(&Eeprom2,     F_WRITE, Adr, (Ptr)(Buf), Cnt)
